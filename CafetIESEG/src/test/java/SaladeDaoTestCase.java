...
public class SaladeDaoTestCase {
	...
	public void initDb() throws Exception {
		...
		stmt.executeUpdate("INSERT INTO `salade` (`nom`, `prix_solo`, `prix_menu`) VALUES	('Salade Composée', 3, 4.5)");
		stmt.close();
		connection.close();
	}
	...
	public void testGetSalades() {
		Salades Salades = SaladesDao.getSalade("Salade Composée");
	...
	public void testGetSaladesSansResultat() {
		Salades Salades = SaladesDao.getSalade("");
		Assert.assertNull(Salades);		
	}
	
	@Test
	public void testAjouterSalades() throws Exception {
		Salades Salades = new Salades("Salade chèvre",3.40,4.9);
		...
		stmt.setString(1, SaladesAjoute.getNom());
	...
	public void testSupprimerSalades() throws Exception {
		Salades Salades = new Salades("Salade mer",3.50,5);
		SaladesDao.ajouterSalade(Salades);
		
		int i = SaladesDao.listerSalades().size();
		Assert.assertEquals(2,i);
		
		SaladesDao.supprimerSalade("Salade mer");
