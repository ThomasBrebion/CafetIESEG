		...
		<div class="row">
			<div class="col-md-8">
				...
				<form method="post" class="form-horizontal">
					...
					<div class="form-group">
						<label for="prix_solo" class="col-sm-2 control-label"><fmt:message key="prixsolo"/></label>
						<div class="col-sm-3">
							<input type="text" placeholder="Ex : 2.4" class="form-control" name="prix_solo" id="prix_solo">
						</div>
					</div>
					<div class="form-group">
						<label for="prix_menu" class="col-sm-2 control-label"><fmt:message key="prixmenu"/></label>
						<div class="col-sm-3">
