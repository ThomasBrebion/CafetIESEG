            ...
            <div class="box">
                <div class="col-lg-12">
                    ...
                    <h2 class="intro-text text-center">
                    	<fmt:message key="sandwich.add" />
                    </h2>
                    
                    <hr>
                    
		<h2>${messageErreur1}</h2>
				...
				<form method="post" class="form-horizontal" id="form" name="form">
					...
					<div class="form-group">
						<label for="prixsolo" class="col-sm-2 control-label"><fmt:message key="prixsolo"/></label>
						<div class="col-sm-3">
							<input type="number" min="0" step="0.01" class="form-control" name="prix_solo" id="prix_solo">
						</div>
					</div>
					<div class="form-group">
						<label for="prixmenu" class="col-sm-2 control-label"><fmt:message key="prixmenu"/></label>
						<div class="col-sm-3">
							<input type="number" min="0" step="0.01" class="form-control" name="prix_menu" id="prix_menu">
						</div>
					</div>
					<div class="form-group">
