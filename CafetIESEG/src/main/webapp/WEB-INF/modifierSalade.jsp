...
<body>
   ...
   <a href="accueil"><img id="logo" src="img/logo.jpg" /></a>
    ...
    <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    ...
                    <h2 class="intro-text text-center">
                    	<fmt:message key="modifier" /> Salade
                    </h2>
		...
		<c:if test="${ not empty salade }">
		<form method="post" class="form-horizontal"  accept-charset="ISO-8859-1">
		<input type="hidden" name="id" id="id" value="${salade.id}">
					<div class="form-group">
						<label for="nom2" class="col-sm-2 control-label"><fmt:message key="name" /></label>
						<div class="col-sm-3">
							<input type="text" class="form-control" name="nom" id="nom" value="${salade.nom}">
						</div>
					</div>
					<div class="form-group">
						<label for="date" class="col-sm-2 control-label"><fmt:message key="prixsolo" /></label>
						<div class="col-sm-3">
							<input type="number" min="0" step="0.1" class="form-control" name="prix_solo" id="prix_solo" value="${salade.prix_solo}">
						</div>
					</div>
					<div class="form-group">
						<label for="date" class="col-sm-2 control-label"><fmt:message key="prixmenu" /></label>
						<div class="col-sm-3">
							<input type="number" min="0" step="0.1" class="form-control" name="prix_menu" id="prix_menu" value="${salade.prix_menu}">
						</div>
					</div>
					<div class="form-group">
