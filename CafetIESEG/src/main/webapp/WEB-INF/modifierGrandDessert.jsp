...
<body>
   ...
   <a href="accueil"><img id="logo" src="img/logo.jpg" /></a>
    ...
    <div class="row">
		...
		<c:if test="${ not empty grand_dessert }">
		<form method="post" class="form-horizontal"  accept-charset="ISO-8859-1">
		<input type="hidden" name="id" id="id" value="${grand_dessert.id}">
					<div class="form-group">
						<label for="nom2" class="col-sm-2 control-label"><fmt:message key="name" /></label>
						<div class="col-sm-3">
							<input type="text" class="form-control" name="nom" id="nom" value="${grand_dessert.nom}">
						</div>
					</div>
					<div class="form-group">
						<label for="date" class="col-sm-2 control-label"><fmt:message key="prix" /></label>
						<div class="col-sm-3">
							<input type="number" min="0" step="0.1" class="form-control" name="prix" id="prix" value="${grand_dessert.prix}">
						</div>
					</div>
