        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    ...
                    <h1 class="brand-name" align="center"><fmt:message key="granddessert.titre" /></h1>
				   ...
				   <h3 align="center"><fmt:message key="granddessert.text1" /></h3><h4 align="center"><fmt:message key="granddessert.text2" /></h4>
                    ...
                    <table class="table">
                    		...
                    		<tr class="tr">
                    			<td class="td">${grand_dessert.id}</td>
                    			<td class="td">${grand_dessert.nom}</td>
                    			<td class="td">${grand_dessert.prix} €</td>
                    			<td class="td"><a href="
                    ...
                    <hr>                   
     				...
     				<h3 align="center"><A href="ajouterGrandDessert"><fmt:message key="granddessert.add"/></A></h3>
                  
                  <div class="nextandprevious">
                  
                  <div class="gauche">
                  	<a href="petitdessertprive"><span class="glyphicon glyphicon-arrow-left"></span></a>
                  </div>
                  
                  <div class="droit">
                  	<a href="sandwichprive"><span class="glyphicon glyphicon-arrow-right"></span></a>
                  </div>
