            ...
            <div class="box">
                <div class="col-lg-12 text-center">
				   ...
				   <h3><fmt:message key="boisson.text1" /></h3><h4><fmt:message key="boisson.text2" /></h4>
                    ...
                    <h3 align="center"><A href="javascript:ouvre_popup('supprimerBoisson')">Supprimer une boisson</A></h3>
					<SCRIPT>
					   function ouvre_popup(page) {
					       window.open(page,"Supprimer boisson","menubar=no, status=no, menubar=no, width=600, height=500");
					   }
					</SCRIPT>
