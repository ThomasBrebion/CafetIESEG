        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                  ...
                  <div class="gauche">
                  	<a href="sandwichprive"><span class="glyphicon glyphicon-arrow-left"></span></a>
                  </div>
                  
                  <div class="droit">
                  	<a href="saladeprive"><span class="glyphicon glyphicon-arrow-right"></span></a>
                  </div>
