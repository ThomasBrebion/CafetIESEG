...
<body>
   ...
   <a href="accueil"><img id="logo" src="img/logo.jpg" /></a>
    ...
    <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    ...
                    <h2 class="intro-text text-center">
                    	<fmt:message key="modifier" /> Boisson
                    </h2>
		...
		<input type="hidden" name="id" id="id" value="${boisson.id}">
					<div class="form-group">
						<label for="nom2" class="col-sm-2 control-label"><fmt:message key="name" /></label>
						<div class="col-sm-3">
							<input type="text" class="form-control" name="nom" id="nom" value="${boisson.nom}">
						</div>
					</div>
					<div class="form-group">
						<label for="date" class="col-sm-2 control-label"><fmt:message key="prix" /></label>
						<div class="col-sm-3">
							<input type="number" min="0" step="0.1" class="form-control" name="prix" id="prix" value="${boisson.prix}">
						</div>
					</div>
