...
public class MotDePasseUtils {
	...
	public static void main(String[] args) {
		try {
			//System.out.println(String.format("test@chouette.vision=%s", MotDePasseUtils.genererMotDePasse("testpass")));
			//System.out.println(String.format("test2@chouette.vision=%s", MotDePasseUtils.genererMotDePasse("testpass")));
			System.out.println(String.format("cafetieseg@ieseg.fr=%s", MotDePasseUtils.genererMotDePasse("admin")));
