...
@WebServlet("/granddessertprive")
public class GrandDessertPriveServlet extends GenericServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher view = request.getRequestDispatcher("/WEB-INF/grand-dessert_prive.jsp");
