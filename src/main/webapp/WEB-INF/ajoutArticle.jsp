		...
		<h2>${message}</h2>
				...
				<form method="post" class="form-horizontal" id="form" name="form">
					<div class="form-group">
						<label for="titre" class="col-sm-2 control-label"><fmt:message key="titre" /></label>
						<div class="col-sm-3">
							<input type="text" class="form-control" name="titre" id="titre">
						</div>
					</div>
					<div class="form-group">
						<label for="texte" class="col-sm-2 control-label"><fmt:message key="texte" /></label>
						<div class="col-sm-3">
							<textarea name="text" rows="5" cols="78"></textarea>
						</div>
					</div>
					<div class="form-group">
						<label for="auteur" class="col-sm-2 control-label"><fmt:message key="auteur" /></label>
						<div class="col-sm-3">
