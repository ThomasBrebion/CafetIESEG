        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    ...
                    <h1 class="brand-name" align="center"><fmt:message key="petitdessert.titre" /></h1>
					
                    <hr class="tagline-divider">
                   
				   <h3 align="center"><fmt:message key="petitdessert.text1" /></h3>
                  ...
                  <div class="gauche">
                  	<a href="boisson"><span class="glyphicon glyphicon-arrow-left"></span></a>
                  </div>
                  
                  <div class="droit">
                  	<a href="granddessert"><span class="glyphicon glyphicon-arrow-right"></span></a>
                  </div>
