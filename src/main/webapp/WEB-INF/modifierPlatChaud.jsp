...
<body>
   ...
   <a href="accueil"><img id="logo" src="img/logo.jpg" /></a>
    ...
    <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    ...
                    <h2 class="intro-text text-center">
                    	<fmt:message key="modifier" /> Plat chaud
                    </h2>
		...
		<c:if test="${ not empty plat_chaud }">
		<form method="post" class="form-horizontal"  accept-charset="ISO-8859-1">
		<input type="hidden" name="id" id="id" value="${plat_chaud.id}">
					<div class="form-group">
						<label for="nom2" class="col-sm-2 control-label"><fmt:message key="name" /></label>
						<div class="col-sm-3">
							<input type="text" class="form-control" name="nom" id="nom" value="${plat_chaud.nom}">
						</div>
					</div>
					<div class="form-group">
						<label for="date" class="col-sm-2 control-label"><fmt:message key="prixsolo" /></label>
						<div class="col-sm-3">
							<input type="number" min="0" step="0.1" class="form-control" name="prix_solo" id="prix_solo" value="${plat_chaud.prix_solo}">
						</div>
					</div>
					<div class="form-group">
						<label for="date" class="col-sm-2 control-label"><fmt:message key="prixmenu" /></label>
						<div class="col-sm-3">
							<input type="number" min="0" step="0.1" class="form-control" name="prix_menu" id="prix_menu" value="${plat_chaud.prix_menu}">
						</div>
					</div>
